 ...
 *
 * @project nazha-core
 * @file com.iterlife.nazha.core.resolver.JobResolver.java
 * @version 1.0.0
 ...
 * @tags 
 */
public abstract class JobResolver implements EnvironmentCapable, ResourceLoaderAware {
    ...
    public JobResolver(Environment environment) {
